...
Canadian Institute for Health Information. Canadian COVID-19 Intervention Timeline — Data Tables. Ottawa, ON: CIHI; October 13, 2022. 
...
# Manual clean up of mandates
man <- vroom("mandates.csv") |>
  # filter(!mandate_id %in% c(26, 40, 43, 52)) |>
