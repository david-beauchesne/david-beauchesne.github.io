...
mypubs <- function(my_orcid = "0000-0002-3590-8161") {
  ...
  filename <- "code/publications.bib"
  ...
  system("pandoc code/publications.bib -s -f biblatex -t markdown -o data/publications.yml")

  system("

  pandoc code/publications.bib -s -f biblatex -t csljson -o data/publications.json
